...
Server administrators are solely responsible for the content of any custom messages configured through Honeypot. Do **not** use the bot to send or automate messages that may be considered harmful, threatening, discriminatory, or inappropriate.

Do not use the bot to transmit any private or sensitive data. Users are encouraged to report abuse to Discord and contact the bot owner at https://riskymh.dev.

### Bot Operator Commitment

Only Discord server administrators can change the channels and messages that the bot manages. The bot operator will never intentionally reconfigure your server’s channels or messages in a harmful way or circumvent your intentions as an administrator. All configuration changes performed by the official Honeypot bot are a direct result of administrator actions or explicit server settings.

### User Responsibilities

For the purposes of this policy, “moderator” means any Discord server owner, administrator, or person with permission to configure the bot. “Member” means any user who is a member of a Discord server where Honeypot is installed.
...
- Not using Honeypot’s features in ways that are deceptive, harmful, or violate Discord’s Terms of Service - including intentionally configuring a commonly used channel, such as #general, as the honeypot to cause mass bans or similar disruptions;
...
The bot operator is not liable for any actions taken against members as a result of them sending messages in a honeypot channel, including bans, timeouts, or other moderation actions triggered by the bot’s automated enforcement. All server members are subject to the configuration choices made by moderators (administrators) of the bot, and it is the responsibility of those users to communicate the presence and purpose of the honeypot channel to their communities.
